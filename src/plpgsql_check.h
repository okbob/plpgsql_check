...
enum
{
	PLPGSQL_CHECK_FORMAT_INVALID = 0,
...
extern void plpgsql_check_put_text_line(plpgsql_check_result_info *ri, const char *message, int len);
...
extern void plpgsql_check_expr_prepare_plan(PLpgSQL_checkstate *cstate, PLpgSQL_expr *expr);
extern bool plpgsql_check_apply_inline_pragmas(PLpgSQL_checkstate *cstate, SelectStmt *selectStmt,
